...
namespace NexiCheckout\Application\Model\ResourceModel;

use OxidEsales\EshopCommunity\Internal\Container\ContainerFactory;
use OxidEsales\EshopCommunity\Internal\Framework\Database\QueryBuilderFactoryInterface;

class NexiCheckoutTransactions
{
    ...
    protected static $sTableName = "nexi_checkout_transactions";
    ...
    public static function getTransactionIdByOrderId(string $orderId): string
    {
    ...
    public function getPaymentStatusByOrderId(string $orderId): int
    {
    ...
    public function getChargeInfo($sTransactionId, $sChargeId, $sProductRef)
    {
     ...
     /**
     * Returns the transaction data from nexi_checkout_transaction table by given payment id
     *
